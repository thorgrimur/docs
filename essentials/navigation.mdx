...
For example, to have a page at [`https://yoursite.com/your-folder/your-page`](https://yoursite.com/your-folder/your-page) you would make a folder called `your-folder` containing an MDX file called `your-page.mdx`.
